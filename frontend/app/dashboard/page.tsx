...
export default function DashboardPage() {
  const [userId] = useState("user123"); // TODO: Replace with actual auth
  const { expenses, loading, error } = useExpenseStore();
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">AI-Powered Expense Management System</p>
        </div>
